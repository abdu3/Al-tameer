    ...
    <div class="footer">
       <div class="container">
          <div class="row">
             ...
             <div class=" col-md-3 col-sm-6">
                <h3>{{__('main.foo-help-h')}} </h3>
                <p  class="variat pad_roght2">{{__('main.foo-help-b')}}
                </p>
             </div>
             <div class="col-md-3 col-sm-6">
             ...
             <div class="col-md-3 col-sm-6">
                <h3>{{__('main.foo-vision-h')}}</h3>
                <p  class="variat">{{__('main.foo-vision-b')}}
                </p>
             </div>
          </div>
       </div>
          ...
          <div class="container">
             <div class="row">
                <div class="col-md-10 offset-md-1">
                   <p>© 2022 All Rights Reserved. Develop by <a href="https://www.linkedin.com/in/abdurazaq-al-hamri-6440191ab/">Eng: Abdurzaq Alhmri</a> 	&amp; <a href="https://abdullah1053.github.io/AbdullahAdemi/">Abdullah Ademi</a></p>
                </div>
             </div>
          </div>
       </div>
